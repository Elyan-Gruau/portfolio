...
export const Work = ({technolist,bgImgName,bgGradient,title,date,state,person_count,description,displayImageInRow = false}:WorkProps) =>{
    let imageSrc= "/portfolio/img/projects/"+bgImgName;
    const technos = [];
    const technoIterrator = technolist;
    const computedBgGradient = bgGradient == null ? "linear-gradient(138deg, #ffffff, #000000)" : bgGradient
